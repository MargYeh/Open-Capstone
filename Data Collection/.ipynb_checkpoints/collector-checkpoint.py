...
if __name__ == "__main__":
    ...
    if initial.upper() == 'Y':
        for year in range(2005, 2024):  # Looping from 2005 to 2023
            getdata(str(year), "acs/acs1", 'B19001')
        logger.info("Census data retrieval completed for years 2005 to 2023, acs/acs1, B19001")
    else:
